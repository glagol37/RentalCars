...
public final class RoutingUtils {
	...
	public static void redirect(String url, HttpServletRequest req, HttpServletResponse resp) throws IOException {
		resp.sendRedirect(url + "?language=" + req.getAttribute("language"));
	}
	...
	public static void redirect(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		redirect("/RentalCars/products", req, resp);
	}
}
